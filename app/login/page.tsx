        ...
        <Card className="border-0 shadow-2xl bg-card/80 backdrop-blur-sm">
          <CardHeader className="space-y-4 pb-8 text-center">
            ...
            <div className="space-y-2">
              ...
              <CardDescription className="text-base text-muted-foreground leading-relaxed">
                Sign in to access your personalized quiz experience and track your learning progress
              </CardDescription>
            </div>
          </CardHeader>
          <CardContent className="space-y-6 px-8 pb-8">
            ...
            <div className="text-center">
              ...
              <Link href="/signup" className="inline-flex items-center justify-center w-full h-12 rounded-xl border border-border/50 bg-background hover:bg-muted/50 text-foreground font-medium transition-all duration-200 group">
                Create New Account
                <span className="ml-2 group-hover:translate-x-1 transition-transform duration-200">✨</span>
              </Link>
            </div>
